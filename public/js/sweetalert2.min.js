!(function (e, t) {
    ...
    const Te = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
        ...
        Ue = (e, t) => {
            let n = e.innerHTML,
                o;
            var i;
            t.iconHtml ? (o = ze(t.iconHtml)) : "success" === t.icon ? ((o = Fe), (n = n.replace(/ style=".*?"/g, ""))) : (o = "error" === t.icon ? Re : ((i = { question: "?", warning: "!", info: "i" }), ze(i[t.icon]))), n.trim() !== o.trim() && w(e, o);
        },
        We = (e, t) => {
            if (t.iconColor) {
    ...
    var pn = { email: (e, t) => (/^[a-zA-Z0-9.+_-]+@[a-zA-Z0-9.-]+\.[a-zA-Z0-9-]{2,24}$/.test(e) ? Promise.resolve() : Promise.resolve(t || "Invalid email address")), url: (e, t) => (/^https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-z]{2,63}\b([-a-zA-Z0-9@:%_+.~#?&/=]*)$/.test(e) ? Promise.resolve() : Promise.resolve(t || "Invalid URL")) };
    function mn(e) {
        var t, n, o;
        (t = e).inputValidator ||
    ...
    const gn = (l, u, d) =>
            new Promise((e, t) => {
                ...
                ot.swalPromiseResolve.set(l, e),
                    ...
                    (i = n),
                    Ge(e),
                    t.toast || ((e.keydownHandler = (e) => nt(o, e, i)), (e.keydownTarget = t.keydownListenerCapture ? window : h()), (e.keydownListenerCapture = t.keydownListenerCapture), e.keydownTarget.addEventListener("keydown", e.keydownHandler, { capture: e.keydownListenerCapture }), (e.keydownHandlerAdded = !0)),
                    (a = l),
